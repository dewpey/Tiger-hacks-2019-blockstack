...
class SignedIn extends Component {
  ...
  saveMe(me) {
    ...
    this.userSession
      .putFile(ME_FILENAME, JSON.stringify(me), options)
      .finally(() => {
      ...
      <div className="SignedIn">
        ...
        <Switch>
          <Route
            path="/animals"
            render={routeProps => (
              <OptionsList type="animals" {...routeProps} />
            )}
          />
          <Route
            path="/territories"
            render={routeProps => (
              <OptionsList type="territories" {...routeProps} />
            )}
          />
          <Route
            path="/others"
            render={routeProps => (
              <OtherKingdoms type="territories" {...routeProps} />
            )}
          />
          <Route
            path="/me"
